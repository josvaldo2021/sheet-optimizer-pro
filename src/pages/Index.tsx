        ...
        <SidebarSection title={`Lista de Peças (${totalPieces})`} icon="📦" defaultOpen={true}>
          <div className="flex flex-col" style={{ background: 'hsl(0 0% 7%)' }}>
            ...
            <div className="max-h-[280px] overflow-y-auto p-2.5 cnc-scroll">
              {/* Header */}
              {pieces.length > 0 && (
              <div className="grid gap-1 mb-1 text-[9px] font-bold uppercase" style={{ gridTemplateColumns: '20px 1fr 1fr 15px 1fr 1fr 20px', color: 'hsl(0 0% 45%)' }}>
              ...
              {pieces.map(p => (
                <div key={p.id} className="cnc-inv-item" style={{ gridTemplateColumns: '20px 1fr 1fr 15px 1fr 1fr 20px' }}>
